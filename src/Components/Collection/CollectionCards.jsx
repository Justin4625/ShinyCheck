                ...
                return (
                    ...
                    >
                        ...
                        <div className="w-full flex justify-between items-start mb-3 z-10">
                            <div
                                className={`px-2.5 py-1 ${isPlza ? "bg-cyan-500 rounded-full shadow-md shadow-cyan-200" : ""} ${isPogo ? "bg-emerald-500 rounded-lg shadow-emerald-200" : "transform -skew-x-12 shadow-sm"}`}
                        ...
                        <div className="w-full space-y-2 z-10 mt-auto">
                            {/* Verberg Encounters/Duration voor POGO als die 0 zijn, anders laten staan */}
                            {!isPogo && (
                                <>
                            ...
                            {/* Captured Date */}
                            <div className={`flex justify-between items-center px-4 py-1.5 rounded-lg border-b ${isPlza ? "border-cyan-100" : isPogo ? "border-emerald-100" : "bg-gray-50/50 border-gray-100 transform -skew-x-3"}`}>
                            ...
                            {/* Game Label */}
                            <div className={`w-full py-2 rounded-xl shadow border flex justify-center items-center 
                                ${isPlza ? "bg-slate-800 border-slate-700" : ""} 
                                ${isPogo ? "bg-emerald-500 border-emerald-400" : ""} 
                                ${isSv ? "bg-gray-800 border-gray-700 transform skew-x-[-6deg]" : ""}`}
                            >
