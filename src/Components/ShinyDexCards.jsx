                ...
                displayedPokemon.map((entry) => {
                    ...
                    return (
                        <div
                            ...
                            className="relative w-full bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer flex flex-col items-center p-5 sm:p-6 border border-gray-300"
                        >
                            {/* Nummer en naam */}
                            <div className="w-full flex justify-between items-center mb-3">
                                ...
                                <span className="px-2 py-1 text-xs sm:text-sm font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 text-white rounded-full shadow-md">
                                    #{number}
                                </span>
                            </div>
                            ...
                            <div className="relative">
                                <img
                                    ...
                                    alt={entry.name}
                                    className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 drop-shadow-lg"
                                />
                                {/* Glow overlay */}
                                <div className="absolute inset-0 rounded-3xl ring-1 ring-cyan-400/30 pointer-events-none animate-pulse"></div>
                            </div>
