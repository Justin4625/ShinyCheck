                ...
                <div className="w-full lg:flex-shrink-0 lg:max-w-[280px] flex flex-col gap-2">
                    <div className="flex items-center justify-between lg:justify-end gap-3 px-1 mb-1">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${showMissingOnly ? 'bg-orange-600' : 'bg-gray-300'}`}
                        >
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 rounded-xl border border-gray-400 bg-white/50 focus:outline-none focus:ring-2 focus:ring-orange-300 transition-all duration-300"
                    />
                </div>
            </div>
