...
function Layout() {
    ...
    return (
        <>
            <nav
                className="relative bg-[#0d0d1a] backdrop-blur-md border-b border-cyan-500/30 px-6 py-6 shadow-lg overflow-hidden">

                {/* Futuristic grid overlay */}
                <div
                    className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,255,255,0.05)_1px,transparent_1px),linear-gradient(rgba(0,255,255,0.05)_1px,transparent_1px)] bg-[size:25px_25px]"
                    aria-hidden="true"
                />
        ...
        `}
                ...
                {/* Subtiele animated background effect */}
