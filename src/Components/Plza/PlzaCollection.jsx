                ...
                collectionPokemon.map((entry, index) => {
                    ...
                    return (
                        <div
                            ...
                            className="relative rounded-2xl p-4 sm:p-5 lg:p-6 flex flex-col items-center justify-between transition-transform duration-300 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 text-gray-900 shadow-md"
                        >
                            {/* Blobs */}
