...
export default function Plza() {
    ...
    // Bepaal welke Pokémon getoond worden (zonder collection — dat handled PlzaCollection)
    ...
    return (
        <div className="relative p-4 sm:p-6 lg:p-8 min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 overflow-hidden">
            ...
            {activeTab === "collection" ? (
                // Verplaatst naar aparte component
                <PlzaCollection
                                ...
                                >
                                    ...
                                    {activeTab === "active" && entry.storedData && (
                                        <div className="mt-4 w-full flex flex-col items-center gap-2">
                                            <div
                                                className="w-full bg-gradient-to-r from-pink-500 to-red-500 text-white text-xs sm:text-base font-bold rounded-xl p-2 shadow-md flex justify-between">
                                                <span>Encounters:</span>
                                                <span>{entry.storedData.counter}</span>
                                            </div>
                                            <div
                                                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xs sm:text-base font-bold rounded-xl p-2 shadow-md flex justify-between">
                                                <span>Time:</span>
                                                <span>{formatTime(entry.storedData.timer)}</span>
                                            </div>

                                            <div
                                                className="w-full bg-gradient-to-r from-gray-700 via-gray-600 to-gray-500 text-white text-xs sm:text-base font-bold rounded-xl p-2 shadow-md flex justify-center">
                                                {entry.game}
                                            </div>
                                        </div>
                                    )}
