...
export default function Plza() {
    ...
    return (
        <div className="relative p-8 min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 overflow-hidden">
            ...
            {/* Neon accent circles */}
            <div className="absolute -top-20 -left-10 w-60 h-60 bg-blue-300 rounded-full opacity-10 blur-3xl pointer-events-none"></div>
            <div className="absolute -bottom-32 -right-20 w-80 h-80 bg-purple-300 rounded-full opacity-10 blur-3xl pointer-events-none"></div>
            ...
            <div className="relative grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 z-10">
                {pokemonList.map((pokemon) => (
                    ...
                    >
                        <div className="absolute -top-4 -right-4 w-16 h-16 bg-purple-300 rounded-full opacity-20 blur-2xl pointer-events-none"></div>
                        <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-green-300 rounded-full opacity-20 blur-2xl pointer-events-none"></div>
